...
// <script defer> en gestion.html), así que el array `perritos` y la función
// capitalize() ya existen acá.
...
function renderFormularioCrear() {
    ...
    formulario.addEventListener("submit", (event) => {
        ...
        const nuevoPerrito = perritoDesdeFormulario(datos);
...
function renderFormularioActualizar() {
    ...
    formularioBusqueda.addEventListener("submit", (event) => {
        ...
        formulario.addEventListener("submit", (event) => {
            ...
            // no se mueve de lugar en el array.
            perritos[indice] = perritoDesdeFormulario(datos);
...
// Un listener por botón del sidebar: el data-action del HTML (mostrar-todos,
...
// Al entrar a la página se abre "Mostrar todos" de una vez, así el espacio
// principal nunca queda en blanco esperando el primer click. Va al final
// porque necesita que las funciones y los listeners de arriba ya existan.
activarSidebarItem("mostrar-todos");
